...
class ChatConsumer(AsyncWebsocketConsumer):
    ...
    async def connect(self):
        try:
            ...
            logger.info(f"WebSocket connected for user {self.user_id} in room {self.room_name}")
    ...
    async def handle_create_channel(self):
        try:
            ...
            self.channel = self.stream_client.channel("messaging", self.room_name)
            ...
            logger.info(f"Channel {self.room_name} created successfully")
    ...
    async def handle_send_message(self, data):
        try:
            ...
            logger.info(f"Message sent by {self.username} in channel {self.room_name}")
    ...
    async def chat_message(self, event):
        try:
            ...
            logger.debug(f"Broadcasted message in room {self.room_name}")
        except Exception as e:
